...
public class ArcaneOven extends BlockContainer{
    ...
    public ArcaneOven(boolean activeVersion)
    {
        super(Material.iron);
        this.isActive = activeVersion;
    }
    ...
    {
        blockIcon = iconRegister.registerIcon(Reference.resourcePrefix + "arcaneOven_side");
        iconFront = iconRegister.registerIcon(Reference.resourcePrefix + (this.isActive ? "arcaneOven_front_on" : "arcaneOven_front_off"));
        iconTop = iconRegister.registerIcon(Reference.resourcePrefix + "arcaneOven_top");
    }
    ...
    {
        return Item.getItemFromBlock(ModBlocks.arcaneOvenIdle);
    }
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entityplayer, ItemStack itemstack) {
        ...
        if(itemstack.hasDisplayName()) {
            ((TileEntityArcaneOven)world.getTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
        }
    }
    ...
    public void breakBlock(World world, int x, int y, int z, Block oldblock, int oldMetadata) {
        if(!keepInventory) {
            TileEntityArcaneOven tileentity = (TileEntityArcaneOven) world.getTileEntity(x, y, z);
    ...
    {
        return new TileEntityArcaneOven();
    }

    public static void updateArcaneOvenBlockState(boolean active, World worldObj, int xCoord, int yCoord, int zCoord) {
        ...
        if(active) {
            worldObj.setBlock(xCoord, yCoord, zCoord, ModBlocks.arcaneOvenActive);
        }else{
            worldObj.setBlock(xCoord, yCoord, zCoord, ModBlocks.arcaneOvenIdle);
        }
