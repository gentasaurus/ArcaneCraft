...
public class ShapedRecipesInfuser implements IRecipe
{
    ...
    public ShapedRecipesInfuser(int p_i1917_1_, int p_i1917_2_, ItemStack[] p_i1917_3_, ItemStack p_i1917_4_)
    {
    ...
    public ShapedRecipesInfuser func_92100_c()
    {
